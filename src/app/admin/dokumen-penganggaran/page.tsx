...
export default function TransparansiPKD() {
  ...
  useEffect(() => {
    if(status === 'unauthenticated') {
      ...
      fetch(`https://lab.dima-dan-rendy.shop/dokanggaran`, {
            ...
            {result.map((results: Data, i) => (
              <tbody key={results.id}>
                <tr>
                  ...
                  <td>
                    <a className="btn btn-xs btn-outline btn-primary" target="_blank" href={`https://lab.dima-dan-rendy.shop/assets/dokanggaran/${results.file}`}>
                          Download
                        </a>
                    <ViewPdf {...results} />
