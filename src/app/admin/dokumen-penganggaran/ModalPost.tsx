...
function ModalPostDokpera() {
  const [modal, setModal] = useState(false);
  const [judul, setTitle] = useState<string>("");
  const [dokumen, setDokmumen] = useState<string>("");
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      ...
      const response = await axios.post(
        `https://lab.dima-dan-rendy.shop/dokanggaran`,
        formData,
        {
          headers: {
          ...
          <div className="w-full max-w-xs">
            <form
              ...
              <div className="mb-4">
                <label className="block text-gray-700 text-sm font-bold mb-2">
                  Dokumen
                  <select className="select select-bordered select-sm w-full max-w-xs" value={dokumen} onChange={handleDokumenChange} >
                    <option>-----</option>
...
export default ModalPostDokpera;
